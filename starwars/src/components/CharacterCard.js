    ...
    return (
        ...
        <Card className="card-container">
            ...
            <Card.Content>
                ...
                <Card.Description>{name} is a {gender==="n/a" ? "gender nonconforming being" : gender} with {eyeColor} eyes and {hairColor==="n/a"||hairColor==="none" ? "no" : hairColor} hair.</Card.Description>
            </Card.Content>
        </Card>
    )
}
